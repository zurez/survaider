...
<html lang="en-us">
  <head>
    ...
    <script src="TemplateData/UnityProgress.js"></script>
      <script type="text/javascript" src="arg-1.2.js"></script>
  </head>
  <body class="template">
...
<script>if (!(!Math.fround)) {
  ...
  script.src = "Release/Survaider_game_v1.js";
  document.body.appendChild(script);
} else {
  var codeXHR = new XMLHttpRequest();
  codeXHR.open('GET', 'Release/Survaider_game_v1.js', true);
...
try {
  ...
  codeXHR.send(null);
      ...
      <script type="text/javascript" language="javascript">
        ...
        {
            SendMessage("Logo", "MyFunction", Arg("json"));
        }
      </script>
  </body>
</html>
